...
export const OpenDataApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createOpenDataUnit: async (openDataUnit?: OpenDataUnit, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/open-data/api/open-data-unit/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        destroyOpenDataUnit: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/open-data/api/open-data-unit/{id}/`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export class OpenDataApi extends BaseAPI {
    ...
    public createOpenDataUnit(openDataUnit?: OpenDataUnit, options?: AxiosRequestConfig) {
        return OpenDataApiFp(this.configuration).createOpenDataUnit(openDataUnit, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public destroyOpenDataUnit(id: string, options?: AxiosRequestConfig) {
        return OpenDataApiFp(this.configuration).destroyOpenDataUnit(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public listOpenDataUnits(options?: AxiosRequestConfig) {
        return OpenDataApiFp(this.configuration).listOpenDataUnits(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public partialUpdateOpenDataUnit(id: string, openDataUnit?: OpenDataUnit, options?: AxiosRequestConfig) {
        return OpenDataApiFp(this.configuration).partialUpdateOpenDataUnit(id, openDataUnit, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public retrieveOpenDataUnit(id: string, options?: AxiosRequestConfig) {
        return OpenDataApiFp(this.configuration).retrieveOpenDataUnit(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateOpenDataUnit(id: string, openDataUnit?: OpenDataUnit, options?: AxiosRequestConfig) {
        return OpenDataApiFp(this.configuration).updateOpenDataUnit(id, openDataUnit, options).then((request) => request(this.axios, this.basePath));
    }
}
